...
if __name__ == '__main__':
    ...
    #print(rna_data)
    rna_data = pd.read_excel("D:/Courses/CS5112_Algorithm/data/_tocorrect_T_U.xlsx")
    ...
    print(rna_data)
    rna_data.to_excel("D:/Courses/CS5112_Algorithm/data/results_zuker_tocorrect_T_U.xlsx", sheet_name="zuker")
